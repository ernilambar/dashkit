		...
		wp_add_inline_script(
			...
			'var dashkitConfig = ' . wp_json_encode(
				[
					...
					'i18n'    => [
						'confirm_action' => Strings::get( 'confirm_action' ),
						'action_failed'  => Strings::get( 'action_failed' ),
						'action_done'    => Strings::get( 'action_done' ),
						'request_failed' => Strings::get( 'request_failed' ),
						'items'          => Strings::get( 'items' ),
						'save_options'   => Strings::get( 'save_options' ),
						'saving'         => Strings::get( 'saving' ),
						'saved'          => Strings::get( 'saved' ),
						'save_error'     => Strings::get( 'save_error' ),
						'save_failed'    => Strings::get( 'save_failed' ),
						'options_saved'  => Strings::get( 'options_saved' ),
					],
				]
			) . ';',
			'before'
